...
if (isset($_POST['delivered'])) {
    ...
    $updateQuery = "UPDATE orders SET delivery_confirmed=1 WHERE id='$orderId'";
    ...
    <div class="categolis">
        <table>
            <tr>
                ...
                <th><?php echo '<a href="profile.php?uid='.$user.'" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">My Orders</a>'; ?></th>
                <th><?php echo '<a href="my_delivery.php?uid='.$user.'" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #fff;border-radius: 12px;">My Delivery History</a>'; ?></th>
                        ...
                        <div>
                            <table class="rightsidemenu">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo '<div class="home-prodlist-img"><a href="OurProducts/view_product.php?pid='.$pId.'"><img src="image/product/'.$item.'/'.$picture.'" class="home-prodlist-imgi" style="height: 75px; width: 75px;"></a></div>'; ?></th>
                                    <th>
                                        <?php 
                                        if (!$delivery_confirmed && date('Y-m-d') == $ddate) {
                                            echo '<form method="post" action="">
                                                    <input type="hidden" name="order_id" value="'.$row['id'].'">
                                                    <input type="submit" name="delivered" value="Delivered" style="padding: 5px 10px; background-color: #28a745; color: white; border: none; border-radius: 5px;">
                                                </form>';
